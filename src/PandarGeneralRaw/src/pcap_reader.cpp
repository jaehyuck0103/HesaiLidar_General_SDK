...
void PcapReader::initTimeIndexMap() {
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("Pandar40P", std::pair<int, int>(1250, 1256)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("Pandar40M", std::pair<int, int>(1250, 1256)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("Pandar64", std::pair<int, int>(1182, 1188)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("PandarQT", std::pair<int, int>(1056, 1062)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("Pandar20A", std::pair<int, int>(1258, 1264)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("Pandar20B", std::pair<int, int>(1258, 1264)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("PandarXT-32", std::pair<int, int>(1071, 1065)));
    m_timeIndexMap.insert(
        std::pair<string, std::pair<int, int>>("PandarXT-16", std::pair<int, int>(559, 553)));
}
